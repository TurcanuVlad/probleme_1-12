...
săptămână.
"""
a = int(input("oua facute de 1 gaina in fiecare zi: "))
b = int(input("oua facute de 2 gaina in fiecare zi: "))
c = int(input("oua facute de 3 gaina in fiecare zi: "))
d = int(input("oua facute de 4 gaina in fiecare zi: "))
